class LevelOne extends Phaser.Scene {
    ...
    create() {
        ...
        div.style.backgroundColor = "#090A0B";
        ...
        this.physics.add.overlap(my.sprite.player, this.checkpoint, (obj1, obj2) => {
            ...
            if(my.sprite.player.score == 30){
                ...
                setTimeout(() => {
                    this.scene.start("platformerScene2"); //restart level automatically after 4000 ms
                }, 4000);
            }
        ...
        //remember: particle systems automatically start once they are created,
        //if you do not want this behavior use the stop() function
        my.vfx.walking.stop();
        my.vfx.jumping.stop();

        //then call my.vfx.walking.start(); when you want the system to start
    ...
    update() {
        ...
        if(Phaser.Input.Keyboard.JustDown(this.rKey)) {
            ...
            this.scene.restart("platformerScene1")
        }
